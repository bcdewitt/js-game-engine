define('TiledMap', function(module) {
	...
	class TiledMap {
		...
		constructor(url, onLoadCallback) {
			...
			assetManager.downloadAll(() => {
				...
				assetManager.downloadAll(() => {
					...
					// TODO: call renderToCanvas() for each layer (avoid drawing animated tiles, that comes later)
					// TODO: add rendered canvases to layerCanvases
		...
		renderToCanvas(canvas, layerName, timestamp, x1, y1, x2, y2) {
